...
<div class="container">
    ...
    <div class="row">
        ...
        <body>
            <form action="admin_manage_contact.php" method="post">
                <!-- Toolbar container -->
...
if (isset($_POST['updt_about'])) {
    $about_us_content = $_POST['editor_content'];
    $q1 = "select * from contact";
    $res1 = mysqli_query($con, $q1);
    $count = mysqli_num_rows($res1);
    if ($count == 0) {
        $q2 = "INSERT INTO contact (content) VALUES ('$about_us_content')";
        ...
        $q = "UPDATE contact SET content='$about_us_content'";
    ...
    echo "<script>window.location.href='admin_manage_contact.php';</script>";
}
?>
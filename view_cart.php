    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row p-4">
                ...
                <div class="col-4 card" style="margin-top: 20px; padding: 15px; border: 1px solid black;">
                ...
                <div class="col-8 card" style="margin-top: 20px; padding: 15px; border: 1px solid white;">
                    <div class="row">

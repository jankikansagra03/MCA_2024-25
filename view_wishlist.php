    ...
    <div class="row">
        <div class="col-12">
            <table class="table table-striped">
                ...
                <tbody>
                    <?php
                    $wishlist_query = "SELECT w.id, p.product_name FROM wishlist w JOIN products p ON w.product_id = p.id WHERE w.email='$email'";
                    ...
                    if (mysqli_num_rows($wishlist_result) > 0) {
                        ...
                        while ($wishlist_item = mysqli_fetch_assoc($wishlist_result)) {
                            ...
                            $product_id = $wishlist_item['id'];
                    ?>
                            <tr>
                                <td><?php echo $i; ?></td>
                                <td><?php echo $product_name; ?></td>
                                <td><a href='remove_from_wishlist.php?id=<?php echo $product_id; ?>' class='btn btn-danger'>Remove</a></td>
                            </tr>
                    <?php
                            $i++;
                        }

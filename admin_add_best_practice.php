...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-8 col-xs-12 col-sm-12">
            <form action="admin_add_best_practice.php" method="post" enctype="multipart/form-data" id="form1">

                <div class="form-group">
                    <label for="file1"><b>Select Image</b></label>
...
if (isset($_POST['btn'])) {
    ...
    $q = "insert into best_practices (`img_name`) values('$pic')";
    if (mysqli_query($con, $q)) {
        if (!is_dir('images/best_pratices')) {
            mkdir("images/best_practices");
        }
        move_uploaded_file($_FILES['pic']['tmp_name'], "images/best_practices/" . $pic);
